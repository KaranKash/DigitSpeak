        ...
        with tf.Session(config=tf.ConfigProto(
            ...
            try:
                while ((not coord.should_stop()) and (epoch_count <= MAX_EPOCHS)):
                    ...
                    _, batch_loss, i, mnist_set = sess.run([train, loss, step, mnist], feed_dict={
                    ...
                    print("Epoch %d. Batch %d/%d. Batch Loss %.2f" % (epoch_count, in_batch, num_batches_per_epoch, batch_loss))
